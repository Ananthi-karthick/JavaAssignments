...
ArrayList<Result> result=ResultDao.viewResult(user_id,date);
...
<tr>
<td><%=i++ %></td>
<td><%=results.getQuestion() %></td>
<td><%=results.getCorrectAnswer() %></td>
<td><%=results.getUserAnswer() %></td>
</tr>
<%} %>
</table>
<button type="submit"  onclick="location.href='UserPanel.html'" >Exit</button>
</body>
</html>